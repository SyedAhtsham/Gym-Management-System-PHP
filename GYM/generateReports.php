...
<button class="button" onclick="location.href='reportClasses.php';">List the Time slots in which classes of Fitness and Workout are scheduled on 25-July-2020.</button> <br>
  
<button class="button" onclick="location.href='reportMembers.php';">List all the members who are having Diamond membership type.</button><br> 
<button class="button" onclick="location.href='reportClass2.php';">Find number of classes scheduled by each Staff between 23 July AND 27 July.</button><br>
