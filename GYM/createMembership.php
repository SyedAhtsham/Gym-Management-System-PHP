...
<div class="center">
   ...
   <h2><u>Create New Membership</u></h2>
  
 
<form name="input" action="registerationMemship.php" method="POST">

 <label for="memberID">Member ID: &nbsp; &nbsp; &nbsp;</label>
   <input type="Number" min="0"
    id="memberID" name="memberID" required placeholder="*123" ><br>
  
 <!--  
  <label for="type">Membership Type:</label><br>
  <div style="padding-left: 50px;">
  <input type="radio" id="type" name="type" value="Diamond">
  <label for="type">Diamond ($100)</label><br>
  <input type="radio" id="type" name="type" value="Gold">
  <label for="type">Gold ($50)</label><br>
  <input type="radio" id="type" name="type" value="Silver">
  <label for="type">Silver ($30)</label>

</div> -->

<br><br>
<label for="membershiptype">Choose Membership Type:</label><br><br>
<div style="padding-left: 50px;">
...
if($result=mysqli_query($con,$query))
{
    ...
    <input type="radio" id="class" name="mType" value="<?php echo $rows[0]; ?>">
  <label for="class"> <?php echo $rows[0]."  "; echo "  ($".$rows[1].")";?></label><br>
...
<br>
  ...
  <input type="submit" name="type" class="button" value="Create">
