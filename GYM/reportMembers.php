...
$my_query = "SELECT memberID, fName, lName, tellNo, sex FROM Member WHERE memberID IN (SELECT memberID FROM Membership WHERE type='$x');";
...
<body> 
 ...
 <table  align="center" border="5px" style="width: 800px; line-height: 40px; font-size: 22px;  ">
    ...
    <t>
      ...
      <th style="background-color: #3d4043; color: yellow; font-size: 20px;">MemberID</th>
      ...
      <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Gender</th>
            <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Membership Type</th>
    </t>
