...
<div class="center">
    ...
    <h2><u>Add New Class Information</u></h2>
  
 
<form name="input" action="registerationClass.php" method="POST">

 <label for="classNo">Class ID:     &nbsp; &nbsp; &nbsp; &nbsp;</label>
   <input type="Number" min="0"
    id="classNo" name="classNo" required placeholder="*123" ><br><br>
  <label for="name">Class Name:&nbsp; &nbsp;</label>
  <input type="text" id="name" name="name" required placeholder="*Yoga"><br><br>
  <label for="fee">Fee ($):&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</label>
  <input type="Number" min="0" id="fee" name="fee" required placeholder="*50"><br><br>
  
 <label for="size">Size: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</label>
  <input type="Number" min="0" id="size" name="size"  value="0"><br><br>
...
<label for="staff">Choose Staff:</label><br><br>
<div style="padding-left: 90px;">
 <select name="staffNo" id="staff" >
...
if($result=mysqli_query($con,$query))
{
  ...
  <label for="staff"> <?php echo $rows[1]." "; echo $rows[2]." "; echo "(ID:".$rows[0].")"; ?></label>
</option><br>
