...
$my_query = "SELECT c.classNo,c.name, s.staffNo, s.fNAME, s.lName, COUNT(*) AS myCount

FROM Staff s, Class c, ClassSchedule d 
WHERE s.staffNo = c.staffNo AND c.classNo = d.classNo AND d.cDate BETWEEN '2020-07-23' AND '2020-07-27'
GROUP BY s.staffNo, c.classNo
ORDER BY myCount;";
...
<body> 
 ...
 <table  align="center" border="5px" style="width: 1000px; line-height: 40px; font-size: 22px;  ">
    ...
    <tr>
      <th colspan="6" style="background-color: #3d4043; color: yellow;"><h3>Report Generated</h3></th>
    </tr>
    ...
    <t>
      ...
      <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Last Name</th>
            <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Total Classes Scheduled</th>
