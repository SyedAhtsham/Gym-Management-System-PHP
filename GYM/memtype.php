...
$x = $_GET['var1'];
$query = "SELECT * FROM `MembershipType` WHERE type = '$x'";
...
<body> 
 ...
 <table  align="center" border="5px" style="width: 500px; line-height: 40px; font-size: 22px;  ">

    <tr>
      <th colspan="2" style="background-color: #3d4043; color: yellow;"><h3>MemberShip Type Record</h3></th>
    </tr>
    
    <t>

      <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Membership Type</th>
       <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Cost</th>
