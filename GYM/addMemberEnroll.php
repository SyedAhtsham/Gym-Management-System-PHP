...
<div class="center">
    ...
    <h2><u>Add New Member Information</u></h2>
  
 
<form name="input" action="registeration.php" method="POST">

 <label for="memberID">Member ID:&nbsp; &nbsp;</label>
   <input type="Number" min="0"
    id="memberID" name="memberID" required placeholder="*123" ><br><br>
  <label for="fName">First name: &nbsp; &nbsp;</label>
  <input type="text" id="fName" name="fName" required placeholder="*Ahtsham"><br><br>
  <label for="lName">Last name:&nbsp; &nbsp; &nbsp; </label>
  <input type="text" id="lName" name="lName" required placeholder="*Shah"><br><br>
  
 <label for="tellNo">Contact:&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</label>
  <input type="text" id="tellNo" name="tellNo"  placeholder="03155726162"><br><br>
  
<!--   <label for="sex">Sex:</label>
  <input type="text" id="sex" name="sex"  placeholder="M/F"><br> -->
  ...
  <input type="radio" id="other" name="sex" value="">
  <label for="other">Other</label>


</div>
<br>
<label for="staff">Choose Classes:</label><br>
<div style="padding-left: 50px;">
...
if($result=mysqli_query($con,$query))
{
    ...
    <input type="checkbox" id="class" name="class[]" value="<?php echo $rows[0]; ?>">
  <label for="class"> <?php echo $rows[1]." "; ?></label><br>
...
<input type="checkbox" id="class" name="class" value="">
  <label for="class"> None of Above</label><br>
...
<br>
  ...
  <input type="submit" name="type" class="button" value="insert">
