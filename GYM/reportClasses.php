...
$my_query = "SELECT c.classNo, c.name, s.staffNo, fName, lName, d.cDate, d.cTime FROM Class c, Staff s, ClassSchedule d WHERE c.classNo = d.classNo AND s.staffNo = c.staffNo AND c.name = 'Fitness and Workout' AND d.cDate='2020-07-25'";
...
<body> 
 ...
 <table  align="center" border="5px" style="width: 1000px; line-height: 40px; font-size: 22px;  ">

    <tr>
      <th colspan="7" style="background-color: #3d4043; color: yellow;"><h3>Report Generated</h3></th>
    </tr>
    
    <t>

      <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Class ID</th>
      ...
      <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Last Name</th>
            <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Class Date</th>
                <th style="background-color: #3d4043; color: yellow; font-size: 20px;">Class Time</th>
    </t>
  

    <?php

    if($result=mysqli_query($con, $my_query))
    {
